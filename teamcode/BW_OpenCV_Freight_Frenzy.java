...
@Autonomous(name="Blue Warehouse 2.1")

public class BW_OpenCV_Freight_Frenzy extends LinearOpMode {
        ...
        while (opModeIsActive())
        {
            ...
            if(rectangleArea > minRectangleArea){
                ...
                if(midpointX > 426.0){
                    ...
                    moveBarm(-245, 4);
                    encoderDrive(DRIVE_SPEED, 7, 7, -7, -7, 6);
                    encoderDrive(DRIVE_SPEED, -7.8, -7.8, -7.8, -7.8, 6);
                    ...
                    encoderDrive(DRIVE_SPEED, -24, 24, 24, -24, 6);
                    encoderDrive(DRIVE_SPEED, 25, 25, 25, 25, 6);
