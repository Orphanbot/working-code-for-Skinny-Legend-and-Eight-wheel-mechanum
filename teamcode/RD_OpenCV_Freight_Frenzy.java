...
@Autonomous(name="Red Ducks 2.1")

public class RD_OpenCV_Freight_Frenzy extends LinearOpMode {
        ...
        while (opModeIsActive())
        {
            ...
            if(rectangleArea > minRectangleArea){
                ...
                if(midpointX > 426.0){
                    ...
                    encoderDrive(DRIVE_SPEED, -7.5, -7.5, -7.5, -7.5, 6);
                    robot.Carm.setPosition(0.3); // opens
                    sleep(750);
                    robot.Carm.setPosition(0.65); // closes
                    encoderDrive(DRIVE_SPEED, 18, 18, -18, -18, 8);
                    DRIVE_SPEED = 0.1;
                    encoderDrive(DRIVE_SPEED, -27, 27, 27, -27, 8);
                    DRIVE_SPEED = 0.25;
                    moveBarm(188, 4);
                    robot.Warm.setPower(-0.75);
                    DRIVE_SPEED = 0.1;
                    encoderDrive(DRIVE_SPEED, 29, 29, 29, 29, 8);
                    DRIVE_SPEED = 0.25;
                    ...
                    encoderDrive(DRIVE_SPEED, 20, -20, -20, 20, 8);
                    encoderDrive(DRIVE_SPEED, 5, 5, 5, 5, 8);
                    ...
                    sleep(1000);
                    encoderDrive(DRIVE_SPEED, -8, 8, 8, -8, 6);
                    encoderDrive(DRIVE_SPEED, 11.5, 11.5, -11.5, -11.5, 7);
                    DRIVE_SPEED = 0.1;
                    encoderDrive(DRIVE_SPEED, -26, 26, 26, -26, 8);
                    DRIVE_SPEED = 0.25;
                    moveBarm(235, 4);
                    robot.Warm.setPower(-0.75);
                    DRIVE_SPEED = 0.1;
                    encoderDrive(DRIVE_SPEED, 23, 23, 23, 23, 8);
                    DRIVE_SPEED = 0.25;
                    encoderDrive(DRIVE_SPEED, 5, -5, -5, 5, 8);
                    DRIVE_SPEED = 0.05;
                    encoderDrive(DRIVE_SPEED, 4, 4, 4, 4, 4);
                    DRIVE_SPEED = 0.25;
                    sleep(2500);
                    robot.Warm.setPower(0);
                    encoderDrive(DRIVE_SPEED, 20, -20, -20, 20, 8);
                    encoderDrive(DRIVE_SPEED, 6, 6, 6, 6, 8);
