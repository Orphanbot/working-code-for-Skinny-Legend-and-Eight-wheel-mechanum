...
@Autonomous(name="Red Warehouse 2.1")

public class RW_OpenCV_Freight_Frenzy extends LinearOpMode {
        ...
        while (opModeIsActive())
        {
            ...
            if(rectangleArea > minRectangleArea){
                ...
                if(midpointX > 426.0){
                    ...
                    encoderDrive(DRIVE_SPEED, -9, -9, -9, -9, 6);
                    robot.Carm.setPosition(0.3); // opens
                    sleep(750);
                    robot.Carm.setPosition(0.65); // closes
                    moveBarm(188, 4);
                    encoderDrive(DRIVE_SPEED, -10, -10, 10, 10, 6);
                    encoderDrive(DRIVE_SPEED, 27, -27, -27, 27, 6);
                    encoderDrive(DRIVE_SPEED, 27, 27, 27, 27, 6);
                    ...
                    moveBarm(225, 4);
                    encoderDrive(DRIVE_SPEED, 4, 4, 4, 4, 6);
                    encoderDrive(DRIVE_SPEED, -17, -17, 17, 17, 6);
                    encoderDrive(DRIVE_SPEED, 10, -10, -10, 10, 6);
                    encoderDrive(DRIVE_SPEED, 35, 35, 35, 35, 6);
                    ...
                    moveBarm(-225, 4);
                    encoderDrive(DRIVE_SPEED, -7, -7, 7, 7, 6);
                    encoderDrive(DRIVE_SPEED, -7.6, -7.6, -7.6, -7.6, 6);
                    robot.Carm.setPosition(0.3); // opens
                    sleep(500);
                    robot.Carm.setPosition(0.50);
                    moveBarm(225, 4);
                    encoderDrive(DRIVE_SPEED, -10, -10, 10, 10, 7);
                    encoderDrive(DRIVE_SPEED, 24, -24, -24, 24, 7);
                    encoderDrive(DRIVE_SPEED, 27, 27, 27, 27, 6);
